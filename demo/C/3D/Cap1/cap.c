...
void check_volume(creal vol_n)
{
  ...
  fprintf (stderr,"-------------------------------------------------------\n");
  fprintf (stderr,"---------------- C: cap check (1 cell) ----------------\n");
  ...
  fprintf (stderr,"numerical  volume:  9.4090641039292142e-03\n\n");
  fprintf (stderr,"absolute error   :  5.8935723714487187e-09\n");
  fprintf (stderr,"relative error   :  6.2637140259490625e-07\n");
  fprintf (stderr,"-------------- C: end cap check (1 cell) --------------\n");
  fprintf (stderr,"-------------------------------------------------------\n");
